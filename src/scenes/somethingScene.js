...
audio.src = '/canciones/something.mp3';
audio.preload = 'auto';
audio.volume = 1.0;
audio.muted = false;
...
const subtitles = [
    { start: 7, end: 10, text: "I've been reading books of old" },
    { start: 10, end: 12, text: "The legends and the myths" },
    { start: 12, end: 14, text: "Achilles and his gold" },
    { start: 14, end: 17, text: "Hercules and his gifts" },
    { start: 17, end: 19, text: "Spiderman's control" },
    { start: 19, end: 22, text: "And Batman with his fists" },
    { start: 22, end: 26, text: "And clearly I don't see myself upon that list" },
    { start: 26, end: 29, text: "She said, 'Where'd you wanna go?'" },
    { start: 29, end: 31, text: "How much you wanna risk?" },
    { start: 31, end: 33, text: "I'm not looking for somebody" },
    { start: 33, end: 35, text: "With some superhuman gifts" },
    { start: 35, end: 37, text: "Some superhero" },
    { start: 37, end: 40, text: "Some fairytale bliss" },
    { start: 40, end: 42, text: "Just something I can turn to" },
    { start: 42, end: 45, text: "Somebody I can kiss" },
    { start: 45, end: 47, text: "I want something just like this" },
    { start: 54, end: 56, text: "Oh, I want something just like this" },
    { start: 63, end: 67, text: "Oh, I want something just like this" },
    { start: 73, end: 75, text: "I want something just like this" },
    { start: 80, end: 83, text: "I've been reading books of old" },
    { start: 83, end: 87, text: "The legends and the myths" },
    { start: 87, end: 89, text: "The testaments they told" },
    { start: 89, end: 91, text: "The moon and its eclipse" },
    { start: 91, end: 94, text: "And Superman unrolls" },
    { start: 94, end: 96, text: "A suit before he lifts" },
    { start: 96, end: 100, text: "But I'm not the kind of person that it fits" },
    { start: 100, end: 103, text: "She said, 'Where'd you wanna go?'" },
    { start: 103, end: 105, text: "How much you wanna risk?" },
    { start: 105, end: 107, text: "I'm not looking for somebody" },
    { start: 107, end: 110, text: "With some superhuman gifts" },
    { start: 110, end: 112, text: "Some superhero" },
    { start: 112, end: 114, text: "Some fairytale bliss" },
    { start: 114, end: 117, text: "Just something I can turn to" },
    { start: 117, end: 119, text: "Somebody I can miss" },
    { start: 119, end: 122, text: "I want something just like this" },
    { start: 127, end: 132, text: "Oh, I want something just like this" },
    { start: 138, end: 141, text: "Oh, I want something just like this" },
    { start: 147, end: 150, text: "Oh, I want something just like this" },
    { start: 157, end: 159, text: "Where'd you wanna go?" },
    { start: 159, end: 161, text: "How much you wanna risk?" },
    { start: 161, end: 163, text: "I'm not looking for somebody" },
    { start: 163, end: 166, text: "With some superhuman gifts" },
    { start: 166, end: 168, text: "Some superhero" },
    { start: 168, end: 170, text: "Some fairytale bliss" },
    { start: 170, end: 173, text: "Just something I can turn to" },
    { start: 173, end: 175, text: "Somebody I can kiss" },
    { start: 175, end: 178, text: "I want something just like this" },
    { start: 192, end: 197, text: "Oh, I want something just like this" },
    { start: 211, end: 215, text: "Oh, I want something just like this" },
    { start: 229, end: 234, text: "Oh, I want something just like this" }
];
...
// Función para reproducir audio + subtítulos
export function playSomethingScene() {
  audio.play()
    .then(() => {
...
// TEXTURA
const canvas = document.querySelector('canvas.something');
...
function getWebGLContext(canvas) {
 ...
 TransportableFloatTexType = isWebGL2 ? gl.FLOAT : halfFloat.HALF_FLOAT_OES;
    let formatRGBA;
    let formatRG;
    let formatR;
...
function captureScreenshot() {
    ...
    gl.readPixels(0, 0, dyeWidth, dyeHeight, gl.RGBA, TransportableFloatTexType, pixels);
...
async function initialize() {
    try {
        ditheringTexture = await createTextureAsync(import.meta.env.BASE_URL + 'textura/LDR_RGB1_0.png');
        initFramebuffers();
...
function generateColor() {
    ...
    if (rand < 0.33) {
        h = 0.72 + Math.random() * 0.11;
    } else if (rand < 0.66) {
        h = 0.83 + Math.random() * 0.09;
    } else {
...
canvas.addEventListener('mousedown', (e) => {
    ...
    config.BLOOM_INTENSITY = 0.5;
    config.SPLAT_RADIUS = 0.1;
    const colors = [
        { r: 128 / 255, g: 0, b: 128 / 255 },
        { r: 255 / 255, g: 105 / 255, b: 180 / 255 },
        { r: 255 / 255, g: 0, b: 0 }
    ];
    for (let i = 0; i < 36; i++) {
        let rad = (i * 10 * Math.PI) / 180;
        let dx = Math.cos(rad) * 1500;
