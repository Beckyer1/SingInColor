...
document.body.appendChild(subtitleContainer);
    ...
    // Letras sincronizadas (tiempos corregidos)
    const subtitles = [
        { start: 17, end: 24, text: "'Cause you're a sky, 'cause you're a sky full of stars" },
        { start: 24, end: 31, text: "I'm gonna give you my heart" },
        { start: 31, end: 38, text: "'Cause you're a sky, 'cause you're a sky full of stars" },
        { start: 38, end: 45, text: "'Cause you light up the path" },
        { start: 45, end: 52, text: "I don't care, go on and tear me apart" },
        { start: 52, end: 63, text: "I don't care if you do" },
        { start: 63, end: 67, text: "'Cause in a sky, 'cause in a sky full of stars" },
        { start: 67, end: 74, text: "I think I saw you" },
        { start: 100, end: 107, text: "'Cause you're a sky, 'cause you're a sky full of stars" },
        { start: 107, end: 113, text: "I wanna die in your arms" },
        { start: 113, end: 123, text: "'Cause you get lighter the more it gets dark" },
        { start: 123, end: 128, text: "I'm gonna give you my heart" },
        { start: 130, end: 138, text: "I don't care, go on and tear me apart" },
        { start: 138, end: 148, text: "I don't care if you do" },
        { start: 148, end: 153, text: "'Cause in a sky, 'cause in a sky full of stars" },
        { start: 153, end: 160, text: "I think I see you" },
        { start: 160, end: 168, text: "I think I see you" },
        { start: 215, end: 221, text: "'Cause you're a sky, you're a sky full of stars" },
        { start: 221, end: 228, text: "Such a heavenly view" },
        { start: 228, end: 235, text: "You're such a heavenly view" }, // Corregido
    ];
...
// Manejar el botón nextSong3
const nextSong3 = document.getElementById('nextSong3');
if (nextSong3) {
  nextSong3.addEventListener('click', () => {
    audio.pause();
    audio.currentTime = 0;
    //clearInterval(subtitleInterval);
    console.log('Audio detenido al presionar nextSong3');
  });
}
...
function generateColor() {
    let h;
    // 80% probabilidad de azul, 20% de amarillo
    if (Math.random() < 0.8) {
        // Blue hues
        h = 0.58 + Math.random() * 0.09; // Range: 0.58 to 0.67
    } else {
        // Yellow hues
        h = 0.14 + Math.random() * 0.03; // Range: 0.14 to 0.17
    }
...
canvas.addEventListener('mousedown', (e) => {
    ...
    const colors = [
        { r: 1, g: 1, b: 0 },   // Amarillo (255,255,0)
        { r: 0, g: 0, b: 1 },   // Azul (0,0,255)
        { r: 1, g: 1, b: 1 }    // Blanco (255,255,255)
    ];
